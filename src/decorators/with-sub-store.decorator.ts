...
import { setClassOptions } from "../components/decorator.component";
...
export function WithSubStore({ basePathMethodName, localReducer }: IFractalStoreOptions): ClassDecorator {
