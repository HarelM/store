...
Redux, and @angular-redux2/store. I'll try to explain the basic concepts as we go.
...
This installs Redux and `@angular-redux2/store` (the Redux bindings for Angular).

## Importing @angular-redux2/store into your App.
...
This will allow us to inject services from `@angular-redux2/store` into our app.
...
For simple cases like this, `@angular-redux2/store` exposes a shorthand for selection in the form
